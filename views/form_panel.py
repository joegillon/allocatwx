...
class FormPanel(wx.Panel):
    def __init__(self, parent, prj):
        ...
        frmPanel.SetForegroundColour('white')

        lblName = wx.StaticText(frmPanel, wx.ID_ANY, 'Project Name: ')
        self.txtName = wx.TextCtrl(frmPanel, wx.ID_ANY, '')
        nameSizer = wx.BoxSizer(wx.HORIZONTAL)
        nameSizer.Add(lblName, 0, wx.ALL, 5)
        nameSizer.Add(self.txtName, 0, wx.ALL, 5)

        lblNickname = wx.StaticText(frmPanel, wx.ID_ANY, 'Nickname: ')
        self.txtNickname = wx.TextCtrl(frmPanel, wx.ID_ANY, '')
        ...
        self.txtFirstMonth = wx.TextCtrl(frmPanel, wx.ID_ANY, '')
        lblLastMonth = wx.StaticText(frmPanel, wx.ID_ANY, 'Last Month: ')
        self.txtLastMonth = wx.TextCtrl(frmPanel, wx.ID_ANY, '')
        ...
        frmSizer.Add(nameSizer, 0, wx.ALL, 5)
        frmSizer.Add(nicknameSizer, 0, wx.ALL, 5)
    ...
    def load(self, prj):
        ...
        self.txtFirstMonth.SetValue(prj['first_month'])
        self.txtLastMonth.SetValue(prj['last_month'])
